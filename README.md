...
2. pip install pandas numpy matplotlib scikit-learn statsmodels scipy lime shap dice-ml solas-ai
3. Open the Jupyter Notebook file: `RafayRaza_G40856805_Assignment4.ipynb`
